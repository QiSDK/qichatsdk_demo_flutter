...
class FullImageWebView extends StatefulWidget {
  ...
  @override
  State<FullImageWebView> createState() => _FullImageWebViewState();
}

class _FullImageWebViewState extends State<FullImageWebView> {
...
Page resource error:
  ...
  isForMainFrame: ${error.isForMainFrame}
    ...
    //controller.loadRequest(Uri.parse(widget.message.uri));
  }
